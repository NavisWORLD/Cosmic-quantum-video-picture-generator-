...
Covered Cory-owned original material distributed under the repository's current rights notice is not offered for general commercial reuse. Commercial, enterprise, OEM, hosted-service, integration, AI/ML development, media-generation service, or other broader rights require a separate written agreement signed by Cory Shane Davis and the counterparty.
...
Third-party libraries, SDKs, models, datasets, documentation, provider services, renderers, model weights, and other dependencies remain governed by their respective licenses and service terms.
